...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::get('/products/all/get', 'ProductController@all_products_get')->name('products.all.get');
    Route::get('/products/all/ajax', 'ProductController@all_products_ajax')->name('products.all.ajax');
