...
class ProductController extends Controller
{
    ...
    public function all_products_get(Request $request)
    {
        $products = DB::table('products')->orderBy('id', 'desc')->get();
        // dd($products);
        return view('backend.product.products.index_ajax', compact('products'));
    }
    public function all_products_ajax(Request $request)
    {
    }
