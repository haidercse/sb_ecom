            ...
            <div class=" col-lg-10">
                ...
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                            @php
                                $banner = App\Models\HomeBanner::take(1)->get();
                            ...
                            @foreach ($banner as $key => $img)
                                <div class="carousel-item active">
                                    <img class="d-block w-100 bannar1"
                                        src="{{ asset('uploads/homebanner/' . $img->image) }}" alt="First slide">
                                </div>
                            @endforeach

                            @php
                                $banner = App\Models\HomeBanner::skip(1)
                                    ->take(5)
                                    ->get();
                            @endphp
                            ...
                            @foreach ($banner as $key => $img)
                                <div class="carousel-item">
                                    <img class="d-block w-100 bannar1"
                                        src="{{ asset('uploads/homebanner/' . $img->image) }}" alt="Second slide">
                                </div>
                            @endforeach
    ...
    @endforeach-->
        ...
        <div class="">
            <div class="container">
                ...
                <div class="row">
                    @php
                        $banner = App\Models\AddBanner::take(20)->get();
                    @endphp


                    @foreach ($banner as $key => $img)
                        <div class="col-lg-2 col-md-4 col-sm-6 col-6 pad-lef">
                            ...
                            <div class=" rounded">
                                ...
                                <a class="itemss" href="{{ $img->name }}">
                                    ...
                                    <div class="boxx">
                                        <img class="img_item " src="{{ asset('uploads/banner/' . $img->image) }}"
                                            alt="">
                                        <!--margin-left:40px;-->
                                    </div>
        ...
        <div class="">
            <div class="container">
                ...
                <div class="row">
                    ...
                    @php
                        $banner = App\Models\AddBanner::skip(4)
                            ->take(0)
                            ->get();
                    @endphp
        ...
        <div class="">
            <div class="container">
                ...
                <div class="row">
                    @php
                        $banner = App\Models\AddBanner::skip(8)
                            ->take(0)
                            ->get();
                    @endphp
                    ...
                    @foreach ($banner as $key => $img)
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-3 bg-white">
                            <a class="itemss" href="{{ $img->name }}">
                                <!--<img class="img_item" src="public/uploads/banner/{{ $img->image }}" alt="">-->
                                <img class="img_item" src="{{ asset('uploads/banner/' . $img->image) }}" alt="">
                            </a>
                        </div>
                    @endforeach
    ...
    @section('script')
        <script>
            $(document).ready(function() {
                ...
                $.post('{{ route('home.section.featuredss') }}', {
                    _token: '{{ csrf_token() }}'
                }, function(data) {
