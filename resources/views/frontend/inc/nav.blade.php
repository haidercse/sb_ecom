                    ...
                    @else
                        ...
                        <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                            <a href="{{ route('user.registration') }}"
                                class="text-reset d-inline-block opacity-60 py-2">{{ translate('Sign Up') }}</a>
...
<header class="@if (get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white border-bottom shadow-sm">
    <div class="position-relative logo-bar-area z-1 " style="background-color:#263472 !important">
        <!--bg-white-->
        <div class="container">
